...
export const ChatBot: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-6 right-6 w-96 max-w-[calc(100vw-3rem)] bg-white rounded-2xl shadow-2xl border border-gray-200 flex flex-col z-50 overflow-hidden animate-in slide-in-from-bottom-5 fade-in duration-300 h-[500px]">
           {/* Header */}
                        ...
                        <div className="flex flex-wrap gap-1">
                          {m.sources.map((source, idx) => (
                            <a 
                              ...
                              className="text-xs bg-white border border-gray-200 text-brand-600 px-2 py-1 rounded-md hover:bg-gray-50 hover:border-brand-200 truncate max-w-[200px] flex items-center gap-1 transition-colors"
                              title={source.title}
                            >
