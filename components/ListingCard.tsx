  ...
  return (
    ...
    >
      <div className="relative h-48 w-full overflow-hidden bg-gray-100 dark:bg-gray-700">
        ...
        <button 
          onClick={toggleSave}
          className={`absolute bottom-3 right-3 p-2 rounded-full backdrop-blur-sm transition-all duration-200 z-20 focus:outline-none active:scale-95 ${
            isSaved 
      ...
      <div className="p-5 flex-1 flex flex-col">
        ...
        <div className="grid grid-cols-3 gap-2 border-t border-gray-100 dark:border-gray-700 pt-4 mt-auto">
          ...
          <div className="flex flex-col items-center justify-center text-gray-600 dark:text-gray-400 border-l border-gray-100 dark:border-gray-700">
            <div className="flex items-center font-semibold text-gray-900 dark:text-white">
